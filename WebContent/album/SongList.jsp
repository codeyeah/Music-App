<%@page import="com.musicApp.common.Literals"%>
<%@page import="com.musicApp.beans.Song"%>
...
--%>
<br/><hr/>
<p>List of all available Songs this Music App</p>
<table style="border:1px solid #9DBCEB;">
  <tr>
  ...
  <%
  List<Song> songs = (List<Song>)request.getAttribute(Literals.SONGS_LIST);
  for(Song s : songs){
  %>
  <tr>
   ...
   // System.out.println("ext : "+ext);
    ...
    <td style="border-bottom:1px dotted #9DBCEB;">
    	<a href="download.do?songId=<%=s.getId()%>"><%=s.getDownloadCount()%> times</a>
    </td>
  </tr>          
  <% } %>
</table>
